...
const CODIGOS: Record<string, { telefono: string; precioMultiplier: number }> = {
  "4545": { telefono: "3202417939", precioMultiplier: 1 },      // Juan P
  "8888": { telefono: "3202417939", precioMultiplier: 1.05 },  // Juan P (+5%)
  "0520": { telefono: "3146171647", precioMultiplier: 1 },      // Miguel
  "1741": { telefono: "3146171647", precioMultiplier: 1.05 },  // Miguel (+5%)
...
{ id: 1005, nombre: "Advil Espalda y Cuello x20 Caps", precio: 43800, categoria: "Más Vendidos", imagen: "/escu2.png", stock: 20, masVendido: true },
  ...
  { id: 7899, nombre: "VENOVIT 5% Bolsa x500ml", precio: 18300, categoria: "Más Vendidos", imagen: "/veno.png", stock: 50, masVendido: true },
 ...
 { id: 3864, nombre: "Zopiclona 7.5mg x30 Tbs Expofarma", precio: 9500, precioAntes: 11900, categoria: "Más Vendidos", imagen: "/zoexp.png", stock: 100, },
 { id: 9862, nombre: "Zopiclona 7.5mg x30 Tbs Humax", precio: 12900, categoria: "Más Vendidos", imagen: "/zohum.png", stock: 50, },
 { id: 4150, nombre: "Prazosina 1mg x30 Tbs Expofarma", precio: 4700, categoria: "Más Vendidos", imagen: "/prazo.png", stock: 100, },
  ...
  { id: 6101, nombre: "Tramydol (Tramadol) 200mg x30 Tbs", precio: 21700, categoria: "Más Vendidos", imagen: "/tramydol200.png", stock: 50, masVendido: true },
  { id: 4240, nombre: "Retiblan 50 x50 Caps", precio: 29500, categoria: "Más Vendidos", imagen: "/reti50.png", stock: 50, masVendido: true },
 ...
 { id: 1776, nombre: "Binafar Ibuprofeno + Metocarbamol x24 Tbs", precio: 18000, categoria: "Más Vendidos", imagen: "/bina.png", stock: 100, masVendido: true },
  ...
  { id: 7681, nombre: "Bilsyl (Silimarina) 240mg x20 Caps", precio: 17500, precioAntes:21000, categoria: "Anglopharma", imagen: "/bil.png", stock: 50, },
  ...
  { id: 32, nombre: "Pedialyte 60meq 500ml Fresa", precio: 8900, categoria: "Más Vendidos", imagen: "/pfr.png", stock: 0, masVendido: true },
  { id: 1232, nombre: "Pedialyte 60meq 500ml Uva", precio: 8900, categoria: "Más Vendidos", imagen: "/puv.png", stock: 50, masVendido: true },
  { id: 1132, nombre: "Pedialyte 60meq 500ml Manzana", precio: 8900, categoria: "Más Vendidos", imagen: "/pman.png", stock: 0, masVendido: true },
  ...
  { id: 51, nombre: "Domeboro (Acetato de Aluminio) x30 Sobres", precio: 29000, categoria: "Más Vendidos", imagen: "/dome.png", stock: 50, masVendido: true },
  ...
  { id: 7753, nombre: "Levotiroxina 50mcg x50 Tbs Siegfried", precio: 9800, precioAntes: 11600,  categoria: "Más Vendidos", imagen: "/sie50.png", stock: 0, masVendido: true },
  ...
  { id: 74, nombre: "Langenix (Lansoprazol 30mg) x30 Caps", precio: 7000, categoria: "Más Vendidos", imagen: "/lange.png", stock: 50, masVendido: true },
  ...
  { id: 2795, nombre: "Torrox Etoricoxib 120mg x10 Tbs", precio: 17700, categoria: "Más Vendidos", imagen: "/torrox.png", stock: 50, masVendido: true },
  { id: 8040, nombre: "Epibalin Pregabalina 75mg x30 Caps", precio: 14000, categoria: "Más Vendidos", imagen: "/epi.png", stock: 50, masVendido: true },
  ...
  { id: 1887, nombre: "Electrolit x625ml Ponche de Frutas", precio: 6900, categoria: "Más Vendidos", imagen: "/elepo.png", stock: 0, masVendido: true },
   { id: 5887, nombre: "Amoken Amoxicilina + Acido Clavulánico x14 Tbs", precio: 32400, categoria: "Más Vendidos", imagen: "/aclav.png", stock: 30, masVendido: true },
...
{ id: 126, nombre: "Ibunflash Migran x30 Caps", precio: 55000, categoria: "Más Vendidos", imagen: "/ibuflashx30.png", stock: 40, masVendido: true },
{ id: 127, nombre: "Ibunflash Migran x8 Caps", precio: 14600, categoria: "Más Vendidos", imagen: "/i88.png", stock: 0, masVendido: true },
{ id: 1127, nombre: "Ibunflash Migran x12 Caps", precio: 19600, categoria: "Más Vendidos", imagen: "/i12.png", stock: 50, masVendido: true },
...
{ id: 130, nombre: "Metronidazol 500mg x100 Tbs (GF)", precio: 16200, categoria: "Genfar", imagen: "/m5100.png", stock: 100 },
{ id: 131, nombre: "Quetiapina 25mg x30 Comp (GF)", precio: 8500, categoria: "Genfar", imagen: "/que25.png", stock: 100 }, // Próximo a llegar
{ id: 132, nombre: "Tamsulosina Clorhidrato 0.4mg x30 Cap (GF)", precio: 26500, categoria: "Genfar", imagen: "/tansgf.png", stock: 50 },
...
{ id: 135, nombre: "Lansoprazol 30mg x14 Cap (GF)", precio: 8000, categoria: "Genfar", imagen: "/langf.png", stock: 50 },
{ id: 136, nombre: "Azitromicina 200mg/5ml x15ml (suspensión) (GF)", precio: 10944, categoria: "Genfar", imagen: "/azisgf.png", stock: 0 }, // Próximo a llegar
...
{ id: 8829, nombre: "Ampicilina 1G x100 Tbs (GF)", precio: 75500, precioAntes:76800, categoria: "Genfar", imagen: "/genfarampi.png", stock: 100 },
{ id: 7474, nombre: "Ketoprofeno 100mg x30 Tbs (GF)", precio: 17800, categoria: "Genfar", imagen: "/k10030.png", stock: 100 },
...
{ id: 5014, nombre: "Carbidopa Levodopa 25/250mg x30 Tbs (GF)", precio: 20000, categoria: "Genfar", imagen: "/carvi.png", stock: 8 },
...
{ id: 142, nombre: "Cefalexina Suspensión 250mg x60ml (GF)", precio: 6400, categoria: "Genfar", imagen: "/cesgf.png", stock: 200 },
{ id: 144, nombre: "Diclofenaco 50mg x30 Tbs (GF)", precio: 3600, categoria: "Genfar", imagen: "/d50fgg.png", stock: 70 }, // Próximo a llegar
{ id: 145, nombre: "Diclofenaco 75mg/3ml x10 Amp (GF)", precio: 12400, categoria: "Genfar", imagen: "/digf.png", stock: 100 }, // Próximo a llegar
{ id: 146, nombre: "Lincomicina 600mg/2ml x10 Amp (GF)", precio: 18000, categoria: "Genfar", imagen: "/l600.png", stock: 50 },
...
{ id: 149, nombre: "Valsartán 160mg x14 Tbs (GF)", precio: 14200, categoria: "Genfar", imagen: "/val160.png", stock: 50 },
...
{ id: 153, nombre: "Pregabalina 75mg x30 Cap (GF)", precio: 21300, categoria: "Genfar", imagen: "/pregaa.png", stock: 40 }, // Próximo a llegar
...
{ id: 155, nombre: "Tinidazol 500mg x8 Tbs (GF)", precio: 3600, categoria: "Genfar", imagen: "/t500gf.png", stock: 50 },
...
{ id: 182, nombre: "Omega 3 x30 Caps Totalmax", precio: 12362, categoria: "Naturales", imagen: "/ome3to.png", stock: 0, ivaIncluido: true },
{ id: 1182, nombre: "Omega 3,6,9 x30 Caps Totalmax", precio: 12363, precioAntes: 14300, categoria: "Naturales", imagen: "/ot3.png", stock: 0, ivaIncluido: true },
...
{ id: 2432, nombre: "Biotina x30 Caps Totalmax", precio: 15200, categoria: "Naturales", imagen: "/bioto.png", stock: 50, },
{ id: 2186, nombre: "PropolVik Pastillas Naranja miel x20 Sobres x5", precio: 26500, categoria: "Naturales", imagen: "/propoln.png", stock: 50, },
...
{ id: 2178, nombre: "Colageno 500mg x60 Caps", precio: 16912, categoria: "Naturales", imagen: "/chi.png", stock: 0, ivaIncluido: true },
...
{ id: 1595, nombre: "Parabil Purgante en polvo x20 Gr", precio: 5000, categoria: "Naturales", imagen: "/para.png", stock: 300 },
// ===== RECIPE =====
...
{ id: 207, nombre: "Respirin Gripa x100 Caps", precio: 25000, categoria: "Antigripales", imagen: "/respi.png", stock: 100 },
{ id: 208, nombre: "Congestex x60 Cap", precio: 47000, categoria: "Antigripales", imagen: "/congcap.png", stock: 50 },
...
{ id: 4810, nombre: "Noxpirin Plus x120 Caps", precio: 120000, categoria: "Antigripales", imagen: "/nox120.png", stock: 20 },

{ id: 6340, nombre: "Noxpirin Junior x24 Sobres", precio: 36500, categoria: "Antigripales", imagen: "/noxpij24.png", stock: 30 },
{ id: 214, nombre: "Ashar Gripa x100 Cap", precio: 51500, precioAntes:54600, categoria: "Memphis", imagen: "/ashar.png", stock: 50 },
...
{ id: 680, nombre: "Ungüento #2 tubo x12 Gr", precio: 11000, categoria: "MK", imagen: "/n2.png", stock: 0 },
...
{ id: 243, nombre: "Noraver Día x12 Sobres 15gr", precio: 30900, categoria: "MK", imagen: "/nora12.png", stock: 0 },
...
{ id: 227, nombre: "Lamdotil x16 Tbs", precio: 9800, categoria: "Bioquifar", imagen: "/lando.png", stock: 0 },
...
{ id: 5102, nombre: "Salydrat (Sales de Rehidratación Oral) x25 Sobres", precio: 55000, categoria: "Bioquifar", imagen: "/saly.png", stock: 30 },
{ id: 4252, nombre: "Eucodina Dihidrocodeina x120ml", precio: 5900, precioAntes:6500, categoria: "Bioquifar", imagen: "/eucod.png", stock: 50 },

{ id: 7240, nombre: "Gastritan Suspension x360ml", precio: 16800, categoria: "Bioquifar", imagen: "/tritan.png", stock: 0 },
{ id: 3240, nombre: "Finapar (Albendazol) 200mg x2 Tbs", precio: 1700, categoria: "Bioquifar", imagen: "/fina.png", stock: 140 },
{ id: 4240, nombre: "Hongistina Nistatina Suspensión x60ml", precio: 10800, categoria: "Bioquifar", imagen: "/hong.png", stock: 0 },
...
{ id: 7635, nombre: "Zifluvis 600mg x10 Sobres de 3gr", precio: 8800, categoria: "Bioquifar", imagen: "/zi610.png", stock: 0 },
...
{ id: 1234, nombre: "Aztrobac Suspensión x15ml", precio: 11900, categoria: "Bioquifar", imagen: "/aztro.png", stock: 50 },
...
{ id: 9234, nombre: "Dizmopraz (Lansoprazol) 30mg x28 Caps", precio: 16100, categoria: "Bioquifar", imagen: "/dizmo.png", stock: 20 },
...
{ id: 9252, nombre: "Diexsoprazol (Esomeprazol) 40mg x30 Caps", precio: 14000, categoria: "Bioquifar", imagen: "/di40.png", stock: 50 },
...
{ id: 7210, nombre: "Nitoxipar Nitazoxanida 500mg x6 Tbs", precio: 11600, categoria: "Bioquifar", imagen: "/nito6.png", stock: 0 },


{ id: 240, nombre: "Zivical (Carbonato de Calcio) 600mg x30 Tbs", precio: 11000, categoria: "Bioquifar", imagen: "/zivi.png", stock: 20 },
{ id: 241, nombre: "Zivical-D (Vitamina D3 200UI + Calcio 600mg) x20 Tbs", precio: 8700, categoria: "Bioquifar", imagen: "/zivid.png", stock: 50 },
...
{ id: 3259, nombre: "ActiViral Crema (Aciclovir) al 5% x15gr", precio: 5500, categoria: "Bioquifar", imagen: "/acticr.png", stock: 0 },



// ===== LAPROFF ====
{ id: 266, nombre: "Loratadina 10mg x400 Tbs", precio: 45000, categoria: "Laproff", imagen: "/lora400.png", stock: 30 },
...
{ id: 273, nombre: "Tiamina 300mg x250 Tbs", precio: 42000, categoria: "Laproff", imagen: "/tiaa.png", stock: 60 },
{ id: 274, nombre: "Carbamazepina 200mg x300 Tbs", precio: 120300, categoria: "Laproff", imagen: "/carb.png", stock: 0 }, // Próximo a llegar
{ id: 811, nombre: "Esomeprazol 20mg x100 Tbs", precio: 58200, categoria: "Laproff", imagen: "/e40pp.png", stock: 50 },
{ id: 1811, nombre: "Fluconazol 200mg x100 Caps", precio: 79500, categoria: "Laproff", imagen: "/flu100.png", stock: 100 },
{ id: 7267, nombre: "Losartán Potásico 50mg x30 Tbs", precio: 3300, categoria: "Laproff", imagen: "/lp30.png", stock: 200 },
{ id: 2272, nombre: "Trimebutina 200mg x300 Tbs", precio: 104300, categoria: "Laproff", imagen: "/trimelp.png", stock: 3 },


{ id: 275, nombre: "Naproxeno 500mg x300 Tbs", precio: 93400, categoria: "Laproff", imagen: "/nap500.png", stock: 50 },
...
{ id: 279, nombre: "Sildenafilo 50mg x50 Tbs", precio: 20300, categoria: "Laproff", imagen: "/slp50.png", stock: 0 },
{ id: 281, nombre: "Amitriptilina 25mg x400 Tbs", precio: 50500, categoria: "Laproff", imagen: "/ami25lp.png", stock: 10 },
{ id: 282, nombre: "Albendazol 200mg x50 Tbs", precio: 22200, categoria: "Laproff", imagen: "/al200.png", stock: 50 },
{ id: 283, nombre: "Cetirizina 10mg x400 Tbs", precio: 40200,precioAntes: 43200, categoria: "Laproff", imagen: "/ceti400.png", stock: 20 },
{ id: 4774, nombre: "Zopiclona 7,5mg x50 Tbs", precio: 20100, categoria: "Laproff", imagen: "/zopi50lp.png", stock: 50 },
...
{ id: 286, nombre: "Betametasona 0.1% x40gr", precio: 6000, categoria: "Laproff", imagen: "/betame001lp.png", stock: 50 },
{ id: 287, nombre: "Hidroclorotiazida 25mg x400 Tbs", precio: 30000, categoria: "Laproff", imagen: "/hr400.png", stock: 0 },
{ id: 288, nombre: "Aciclovir 800mg x50 Tbs", precio: 50000, categoria: "Laproff", imagen: "/aci800.png", stock: 50 },
{ id: 289, nombre: "Prednisolona 5mg x100 Tbs", precio: 9700, categoria: "Laproff", imagen: "/pred100.png", stock: 0 },
...
{ id: 295, nombre: "Aciclovir 800mg x10 Tbs", precio: 10200, categoria: "Laproff", imagen: "/aci81.png", stock: 100 },
...
{ id: 302, nombre: "Betahistina Diclorhidrato 8mg x20 Tbs", precio: 22300, categoria: "Laproff", imagen: "/blp8m.png", stock: 20 },
...
{ id: 305, nombre: "Tadalafilo 20mg x4 Tbs", precio: 7500, categoria: "Laproff", imagen: "/tadalp.png", stock: 70 },
...
{ id: 309, nombre: "Clobetasol Propionato 0.05% x40gr", precio: 8000, categoria: "Laproff", imagen: "/clobelp.png", stock: 50 },
{ id: 310, nombre: "Aciclovir Ungüento 5% x15gr", precio: 6300, categoria: "Laproff", imagen: "/aci15.png", stock: 100 },
{ id: 1310, nombre: "Ácido Fusidico 2% x15gr", precio: 6900, categoria: "Laproff", imagen: "/af2.png", stock: 100 },
...
{ id: 317, nombre: "Orocal 600mg x30 Tbs", precio: 15000, categoria: "Laproff", imagen: "/oro.png", stock: 20 },
{ id: 318, nombre: "Enerzinc x90ml", precio: 7600, categoria: "Laproff", imagen: "/ener.png", stock: 50 },
{ id: 319, nombre: "Clotrimazol Vaginal 1% x40gr", precio: 5600, categoria: "Laproff", imagen: "/cvlp.png", stock: 0 },
...
{ id: 321, nombre: "Guayaprof 120ml", precio: 4400, categoria: "Laproff", imagen: "/guaya.png", stock: 145 },
...
{ id: 327, nombre: "Sulfato Ferroso 120ml", precio: 4900, categoria: "Laproff", imagen: "/s12.png", stock: 0 },
...
// ===== COLMED =====
{ id: 350, nombre: "Levotiroxina 100mcg x30 Tbs", precio: 10300, categoria: "Colmed", imagen: "/lev1003.png", stock: 0 }, // Próximo a llegar
...
{ id: 2355, nombre: "Metronist x10 ovulos", precio: 19600, categoria: "Colmed", imagen: "/mov.png", stock: 0 }, 
...
{ id: 3750, nombre: "Tramadol 50mg x10 Caps", precio: 7100, categoria: "Colmed", imagen: "/trapco.png", stock: 0 }, // Próximo a llegar
{ id: 7001, nombre: "FemDuo Metronidazol + Clotrimazol 500/100mg x10 Ovulos", precio: 17500, categoria: "Colmed", imagen: "/femduo.png", stock: 50 }, // Próximo a llegar
...
{ id: 366, nombre: "Vitamina E 400 U.I x100 Cap", precio: 35000, precioAntes:38000, categoria: "Colmed", imagen: "/veco1.png", stock: 50 }, // Próximo a llegar
// ===== COASPHARMA =====
...
{ id: 8367, nombre: "Sales de Rehidratacion Oral x30 sobres", precio: 46400, categoria: "CoasPharma", imagen: "/so30.png", stock: 30 },
...
{ id: 3689, nombre: "Hidroclorotiazida 25mg x240 Tbs", precio: 11000, categoria: "CoasPharma", imagen: "/h25co.png", stock: 0 },
{ id: 7458, nombre: "Piroxicam Gel 0.5% x30gr", precio: 6600, categoria: "CoasPharma", imagen: "/pi6.png", stock: 110 },
{ id: 9024, nombre: "Gemfibrozilo 600mg x20 Tbs", precio: 9800, categoria: "CoasPharma", imagen: "/gem6000.png", stock: 110 },


{ id: 1373, nombre: "Metronidazol 500mg x100 Tbs", precio: 15600, categoria: "CoasPharma", imagen: "/meco.png", stock: 0 },
{ id: 374, nombre: "Piroxicam 20mg x10 Cap", precio: 2800, categoria: "CoasPharma", imagen: "/piroxx.png", stock: 120 },
{ id: 633, nombre: "Norfloxacino 400mg x20 Tbs", precio: 7700, categoria: "CoasPharma", imagen: "/norco.png", stock: 60 },
...
{ id: 387, nombre: "Ibuprofeno + Metocarbamol x24 Tbs", precio: 17900, categoria: "CoasPharma", imagen: "/im.png", stock: 40 },
...
{ id: 390, nombre: "Dermaskin x20gr", precio: 8900, precioAntes: 10000, categoria: "CoasPharma", imagen: "/derma20.png", stock: 50 },
...
{ id: 400, nombre: "Amoxicilina Suspensión x100ml", precio: 5400, categoria: "CoasPharma", imagen: "/as251.png", stock: 0 },
{ id: 401, nombre: "Clindamicina 300mg x24 Cap", precio: 25700, categoria: "CoasPharma", imagen: "/clinco24.png", stock: 100 },


{ id: 403, nombre: "Amoxicilina Suspensión x60ml", precio: 4300, categoria: "CoasPharma", imagen: "/as60.png", stock: 120 },
...
{ id: 411, nombre: "Aciclovir Ungüento 5% x15gr", precio: 5200, categoria: "CoasPharma", imagen: "/aciunc.png", stock: 100 },
{ id: 617, nombre: "Hidrocortisona al 1% x15gr", precio: 4500, categoria: "CoasPharma", imagen: "/hidrocoas.png", stock: 50 },
...
{ id: 419, nombre: "Doxiciclina 100mg x10 Cap", precio: 4000, categoria: "CoasPharma", imagen: "/doxico.png", stock: 100 },
...
{ id: 422, nombre: "Prednisolona 5mg x300 Tbs", precio: 24000, categoria: "CoasPharma", imagen: "/pred300.png", stock: 0 },
{ id: 424, nombre: "Ibuprofeno 400mg x60 Tbs", precio: 8200, categoria: "CoasPharma", imagen: "/i400c.png", stock: 24 },
...
{ id: 433, nombre: "Acetaminofén 500mg x100 Tbs", precio: 5800, categoria: "AG", imagen: "/ace500.png", stock: 0 },
{ id: 434, nombre: "Losartán 50mg x30 Tbs", precio: 3600, categoria: "AG", imagen: "/lo50ag.png", stock: 0 },
{ id: 1434, nombre: "Naproxeno 500mg x10 Tbs", precio: 5300, categoria: "AG", imagen: "/n5a.png", stock: 300 },
...
{ id: 436, nombre: "Naproxeno 250mg x10 Tbs", precio: 2800, categoria: "AG", imagen: "/nap250.png", stock: 0 },
...
{ id: 2475, nombre: "Clotrimazol Vaginal al 1% x40gr", precio: 7300, categoria: "Memphis", imagen: "/c1m.png", stock: 0 }, // Próximo a llegar
...
{ id: 474, nombre: "Amlodipino 10mg x10 Tbs", precio: 2200, categoria: "Memphis", imagen: "/a10mg.png", stock: 0 },
...
{ id: 1629, nombre: "Losartan 50mg x30 Tbs", precio: 4400, categoria: "La Sante", imagen: "/lls.png", stock: 100 },
...
{ id: 118, nombre: "Acnotin Isotretinoina USP 20 mg x30 Caps", precio: 68000, categoria: "Más Vendidos", imagen: "/acno.png", stock: 50, masVendido: true },
...
{ id: 6412, nombre: "LincoDelt Lincomicina 600mg/2ml x10 Amp", precio: 15500, categoria: "Ampolleteria", imagen: "/Lincodelt.png", stock: 50 },
...
{ id: 3685, nombre: "Penicilina 1.2 Mill x1 Vial Vitalis", precio: 2800,  categoria: "Ampolleteria", imagen: "/vi12.png", stock: 0  }, // Próximo
{ id: 9564, nombre: "Tiamina 1g x Vial Vitalis", precio: 6000,  categoria: "Ampolleteria", imagen: "/tivi.png", stock: 0  }, // Próximog
...
{ id: 495, nombre: "Kenacort-A (Acetonida de Triamcinolona) x1 vial x5ml",        precio: 44500, categoria: "Ampolleteria", imagen: "/kena.png", stock: 0  }, // Próximo
...
{ id: 4150, nombre: "Penicilina 2.4 mill x1 vial Sicma",             precio: 2900,  categoria: "Ampolleteria", imagen: "/sic24.png", stock: 50 },
...
{ id: 498, nombre: "Gentamicina 160mg/2ml x10 amp (Farmionni)",       precio: 16800, categoria: "Ampolleteria", imagen: "/gentafar.png", stock: 0 },
...
{ id: 4001, nombre: "Ampicilina/Sulbactam 1.5 g IM/IV x1 vial (Sicma)",precio: 3200,  categoria: "Ampolleteria", imagen: "/ampsic.png", stock: 50 },

{ id: 505, nombre: "Ampidelt Ampicilina/Sulbactam 1.5 g IM/IV x1 vial (Delta)",precio: 3300,  categoria: "Ampolleteria", imagen: "/ampidelt.png", stock: 50 },
...
{ id: 508, nombre: "Hioscina + Dipirona 20mg + 2.5g/5ml x1 amp (Ryan)",      precio: 2800,  categoria: "Ampolleteria", imagen: "/hsry.png", stock: 0 },
{ id: 510, nombre: "Tramadol 100mg/2ml (IV/IM/SC) x10 amp (Farmionni)",           precio: 11900, categoria: "Ampolleteria", imagen: "/trafar.png", stock: 50 },
{ id: 511, nombre: "Pisacaina 2% 20mg/ml 50ml",                       precio: 9000,  categoria: "Ampolleteria", imagen: "/pisa.png", stock: 120 },
{ id: 512, nombre: "CeftriDelt (Ceftriaxona) 1G x1 vial",           precio: 2200,  categoria: "Ampolleteria", imagen: "/cefsic.png", stock: 100  },  
{ id: 1512, nombre: "Ceftriaxona 1G x1 vial",           precio: 3200,  categoria: "Ampolleteria", imagen: "/ce1g.png", stock: 0  },  
...
{ id: 9724, nombre: "Propol1s-Cough Jarabe Hierbabuena x120ml", precio: 8500, categoria: "Jarabes y soluciones", imagen: "/propoh.png", stock: 0 },
{ id: 9725, nombre: "Propol1s-Cough Jarabe Jengibre x120ml", precio: 8500, categoria: "Jarabes y soluciones", imagen: "/propoj.png", stock: 0 },
{ id: 9825, nombre: "Noxpirin Junior Jarabe x120ml", precio: 7900, categoria: "Jarabes y soluciones", imagen: "/noj120.png", stock: 50 },
{ id: 7847, nombre: "Bromyl (Bromhexina + Guaifenesina) Jarabe x120 ml", precio: 8400, categoria: "Jarabes y soluciones", imagen: "/bromy.png", stock: 50 },
...
{ id: 525, nombre: "Acetaminofén x120 ml", precio: 3500, categoria: "Laproff", imagen: "/120ml.png", stock: 200 },
{ id: 526, nombre: "Acetaminofén x90 ml", precio: 3000, categoria: "Laproff", imagen: "/90ml.png", stock: 850 },
{ id: 527, nombre: "Avalpric x120 ml 250 mg/5 ml", precio: 10400, categoria: "Bioquifar", imagen: "/aval.png", stock: 40 },
...
{ id: 2353, nombre: "Sulzinc x80 ml", precio: 11000, categoria: "Jarabes y soluciones", imagen: "/sulz.png", stock: 50 },

{ id: 532, nombre: "Pranexxin (Nitazoxanida 2%) x60 ml", precio: 17300, categoria: "Jarabes y soluciones", imagen: "/prasus.png", stock: 0 },
{ id: 534, nombre: "Trimicort (Clobetasol) Solución x60 ml", precio: 18300, precioAntes:20000, categoria: "Jarabes y soluciones", imagen: "/trimisol.png", stock: 50 },
...
{ id: 1548, nombre: "Pediazinc Sulfato de Zinc x120 ml", precio: 10400, categoria: "Jarabes y soluciones", imagen: "/pezi.png", stock: 0 },
{ id: 2548, nombre: "Hidroxicina HCI 0.25% x120 ml", precio: 8600, categoria: "Anglopharma", imagen: "/hidran.png", stock: 0 },
...
{ id: 550, nombre: "Noktos Niños (Bromhexina + Guayacolato) x120 ml", precio: 7500, categoria: "Jarabes y soluciones", imagen: "/nokni.png", stock: 0 },
...
{ id: 558, nombre: "Multi Soluter x50 ml", precio: 11619, categoria: "Jarabes y soluciones", imagen: "/multso.png", stock: 50, ivaIncluido: true },
...
{ id: 563, nombre: "Albendazol Suspensión (Laproff) x20 ml", precio: 2200, categoria: "Laproff", imagen: "/aslp2.png", stock: 0 },
{ id: 564, nombre: "Furotil (Metronidazol 5.0 g + Nifuroxanida) x120 ml", precio: 8200, precioAntes:12700, categoria: "Jarabes y soluciones", imagen: "/furotil.png", stock: 30 },
...
{ id: 522, nombre: "Benlic (Triconjugada) 20 Gr", precio: 10200, categoria: "Cremas y Ungüentos", imagen: "/benlic20.png", stock: 130 },
{ id: 523, nombre: "Benlic (Triconjugada) 40 Gr", precio: 16200, categoria: "Cremas y Ungüentos", imagen: "/benlic40.png", stock: 100 },
{ id: 1523, nombre: "DKG (Triconjugada) 20 Gr", precio: 6400, categoria: "Cremas y Ungüentos", imagen: "/dkg.png", stock: 100 },
{ id: 524, nombre: "Nelind Crema x40 Gr", precio: 14600, categoria: "Cremas y Ungüentos", imagen: "/nldim.png", stock: 0 },
...
{ id: 935, nombre: "Vaxomizol (Terbinafina) al 1% x20 Gr", precio: 9500, categoria: "Cremas y Ungüentos", imagen: "/vaxo.png", stock: 100 },
...
{ id: 626, nombre: "Clindamicina crema vaginal al 2%", precio: 15800, categoria: "Cremas y Ungüentos", imagen: "/clindcv.png", stock: 0 },
...
{ id: 552, nombre: "Sulfato Ferroso gotas x20 ml", precio: 7200, categoria: "Laproff", imagen: "/sf20.png", stock: 0 },
...
{ id: 554, nombre: "Naf Vision (Nafazolina) 1 mg x7 ml", precio: 5400, categoria: "Gotas", imagen: "/nafvisi.png", stock: 0 },
...
{ id: 562, nombre: "Oftalmotrisol (Nafazolina) 15 ml", precio: 13900, categoria: "Gotas", imagen: "/oftalmo.png", stock: 50 },
...
{ id: 575, nombre: "VitaTriol (Triconjugada) 5 ml", precio: 7300, categoria: "Gotas", imagen: "/vitagt.png", stock: 240 },
...
{ id: 579, nombre: "Eye Zul (Nafazolina Clorhidarto 0.1%) 7 ml", precio: 6600, categoria: "Gotas", imagen: "/zuln.png", stock: 100 },
{ id: 580, nombre: "Cetirizina gotas 15 ml", precio: 7400, categoria: "Memphis", imagen: "/cetigts.png", stock: 50 },
{ id: 581, nombre: "Fire Lips (Ácido Salicílico) 10 ml", precio: 8000, categoria: "Gotas", imagen: "/fire.png", stock: 220 },
{ id: 621, nombre: "Oximetazolina 0,05% (Adulto) x15 ml pb", precio: 6900, categoria: "Gotas", imagen: "/oxipb.png", stock: 0 },
...
{ id: 586, nombre: "Activa 21", precio: 5300, categoria: "Anticonceptivos", imagen: "/ac21.png", stock: 660 }, // Próximo a llegar
...
{ id: 1587, nombre: "Cyclofem Solución Inyectable x1", precio: 17400, categoria: "Anticonceptivos", imagen: "/cym.png", stock: 0 },
{ id: 588, nombre: "PostDay (Levonorgestrel 0.75mg) x2 Tbs", precio: 10600, categoria: "Anticonceptivos", imagen: "/post.png", stock: 0 },
...
{ id: 9356, nombre: "Preservativos Xtrem nornal x3", precio: 5000,  categoria: "Anticonceptivos", imagen: "/xtrem.png", stock: 0 },
...
{ id: 598, nombre: "Gasa Estéril (No tejida) x50 sobres de 6 (Alfa)", precio: 21800, categoria: "Biosanitarios", imagen: "/gasa.png", stock: 55 },
...
{ id: 606, nombre: "Cinta Microporosa Color Piel (2\" x 5 yds) x Und Supreme", precio: 3600, categoria: "Biosanitarios", imagen: "/s2x5.png", stock: 50 },
...
useEffect(() => {
    if (vendedor === "juan") {
      const timer = setInterval(() => {
        setCurrentBanner((prev) => (prev === 0 ? 2 : 0)); // <-- Cambiado a 2 para que muestre la rifa
      }, 5000);
      return () => clearInterval(timer);
    }
  }, [vendedor]);
...
<div className="flex items-center shrink-0 order-1">
    <div className="relative h-9 w-24 md:h-16 md:w-48 drop-shadow-sm">
      <Image src="/logo-tayro.png" alt="Tayro Pharma" fill className="object-contain" priority unoptimized />
    </div>
...
{/* --- SECCIÓN 1: BANNER PRINCIPAL (CARRUSEL DINÁMICO) --- */}
{!search && categoriaActiva === "Más Vendidos" && (
  <div className="bg-[#F1F5F9] pt-6 pb-2 overflow-hidden">
    <div className="max-w-7xl mx-auto px-4 md:px-4 relative h-[320px] md:h-[400px] lg:h-[450px]">
      ...
      >
        Ver productos Memphis
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="relative md:absolute inset-x-0 rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white p-6 md:p-12 flex flex-col md:flex-row items-center justify-start lg:justify-between gap-6 h-full"
            >
              <div className="text-left space-y-3 relative z-30 w-full lg:w-2/3 pb-20 lg:pb-0">
                <h2 className="text-xl md:text-4xl font-extrabold tracking-tight leading-tight">
                  Distribuidora Tayro Pharma SAS
                </h2>
                <h2 className="text-2xl md:text-5xl font-black uppercase leading-none">
                ...
                <div className="flex gap-2 mt-4">
                    <div className="bg-[#cc0000] border-2 border-[#FFFF00] rounded-lg py-1 px-2">
                      <span className="text-white font-black text-[10px] md:text-sm uppercase tracking-tighter">SIN MONTO MÍNIMO PARA PEDIDOS</span>
                    </div>
                </div>
              </div>

              {/* SELLOS PC */}
              <div className="hidden lg:flex absolute right-40 top-1/2 -translate-y-1/2 flex-row -space-x-32 z-20 pointer-events-none">
                <img src="/salud.png" alt="Salud" className="w-80 h-96 object-contain" />
                <img src="/dian.png" alt="DIAN" className="w-80 h-96 object-contain" />
              </div>

              {/* SELLOS CELULAR (Aún más grandes y más unidos) */}
<div className="flex lg:hidden absolute bottom-4 left-1/2 -translate-x-1/2 flex-row items-center justify-center gap-2 z-20 pointer-events-none w-full px-4">
  <img src="/salud.png" alt="Salud" className="w-40 h-40 object-contain filter drop-shadow-xl" />
  <img src="/dian.png" alt="DIAN" className="w-40 h-40 object-contain filter drop-shadow-xl" />
</div>
...
>
  <img
  src={vendedor === "juan" ? "/rifa-camiseta-juan.jpg" : "/rifa-camiseta.jpg"}
          ...
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2 z-40">
            {BANNERS.map((_, idx) => (
              <button
                ...
                className={`h-1.5 transition-all rounded-full ${currentBanner === idx ? "bg-white w-6 shadow-md" : "bg-white/40 w-1.5"}`}
              />
            ))}
          </div>
        )}
